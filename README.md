...
- **Deal.by** — маркетплейс (платформа EVO) с тысячами магазинов: товары для дома, одежда, обувь, бытовые товары, продукты и многое другое — то, чего нет в каталоге Onliner.
...
>
> ⚠️ Специализированные продуктовые сети (Евроопт/e-dostavka, Гиппо, Oz.by) закрыты анти-бот защитой и пока недоступны для прямого API-подключения. Продукты/товары повседневного спроса частично покрывает Deal.by.
